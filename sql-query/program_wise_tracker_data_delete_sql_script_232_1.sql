...
-- 1) trackedentityattributevalueaudit
   ...
   ( select trackedentityinstanceid from programinstance where programid = 552165); 
...
-- 5) trackedentitydatavalueaudit 
	...
	( select programstageinstanceid from programstageinstance where programstageid in 
		( select programstageid from programstage where programid = 552165 )
	);
...
-- 8) programinstancecomments 
	...
	( select programinstanceid from programinstance where programid = 552165 );

-- 9) programinstance 
      delete from programinstance where programid = 552165; 
