...
export function mapDashboardItemToVisualization(
  ...
  return {
    ...
    details: {
      ...
      showCardHeader: true,
      showCardFooter: true,
      showChartOptions: dashboardId !== 'reports',
      showDownloadOptions: dashboardId !== 'reports',
      showFilters: dashboardId !== 'reports',
      showVisualizationTypeOptions: dashboardId !== 'reports',
      showResizeButton: dashboardId !== 'reports',
      showFullScreenButton: dashboardId !== 'reports',
      cardHeight: '450px',
      itemHeight: '430px',
