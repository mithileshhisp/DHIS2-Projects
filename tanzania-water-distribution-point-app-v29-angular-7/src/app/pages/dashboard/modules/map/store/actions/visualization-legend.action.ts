...
export const OPEN_PIN_VISUALIZATION_LEGEND = '[Map UI] Open pinned legend';
...
export class OpenVisualizationLegend implements Action {
  readonly type = OPEN_PIN_VISUALIZATION_LEGEND;
  constructor(public payload: string) {}
}
