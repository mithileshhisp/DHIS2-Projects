...
public class BDImportSheet implements Serializable
{
    ...
    public BDImportSheet(String xmlTemplateName, String displayName, String periodicity, String checkTemplateName, String checkRangeForHeader, String checkRangeForData, Integer sheetNo)
    {
    ...
    public void setSheetNo(Integer sheetNum) {
        this.sheetNo = sheetNum;
    }
