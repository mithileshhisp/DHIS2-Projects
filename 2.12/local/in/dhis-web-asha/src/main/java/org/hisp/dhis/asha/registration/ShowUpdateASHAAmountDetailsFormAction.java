...
public class ShowUpdateASHAAmountDetailsFormAction implements Action
{
    ...
    */
    ...
    //private List<Program> patientPrograms = new ArrayList<Program>();
    ...
    public String execute()
    {
        ...
        */
        ...
        for ( Period period : periods )
        {
            System.out.println( period.getId()  + " -- Name is : " + period.getName() + " -- External Id is : " + period.getExternalId() );
        }
        */
