...
function listAllASHA()
{
	hideById('listASHADiv');
	hideById('advanced-search');
	
	jQuery('#loaderDiv').show();
	contentDiv = 'listASHADiv';
	
	jQuery('#listASHADiv').load('getRegisteredASHAList.action',
	{
		listAll:true
	},
	function()
	{
		showById('listASHADiv');
...
//------------------------------------------------------------------------------
//	Search ASHA by selected attribute
//------------------------------------------------------------------------------
...
function validateAdvancedSearch()
{
	...
	if(flag){
		contentDiv = 'listASHADiv';
		jQuery( "#loaderDiv" ).show();
		advancedSearchASHA( getSearchASHAParams() );
	}
}



function getSearchASHAParams()
{
	var params = "";
	var programIds = "";
...
function advancedSearchASHA( params )
{
	$.ajax({
		url: 'getRegisteredASHAList.action',
		type:"POST",
		data: params,
		success: function( html ){
				
				setInnerHTML( 'listASHADiv', html );
				showById('listASHADiv');
...
function searchASHAOnKeyUp( event )
{
