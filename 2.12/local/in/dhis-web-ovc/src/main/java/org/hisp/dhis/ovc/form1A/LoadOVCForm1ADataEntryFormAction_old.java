...
public class LoadOVCForm1ADataEntryFormAction_old
    implements Action
{
    ...
    public String execute()
    {
        ...
        // System.out.println( period.getStartDateString() + " -- "+
        ...
        /*
         * for( Employee employee : employeeListCHV ) { System.out.println(
         * employee.getCode() + " -- "+ employee.getJobTitle() ); }
         */
        ...
        /*
         * if ( programStageInstanceId == null ) { ProgramStageInstance
         * programStageInstance = new ProgramStageInstance();
         * programStageInstance.setProgramInstance( programInstance );
         * programStageInstance.setProgramStage( programStage );
         * programStageInstance.setOrganisationUnit(
         * patient.getOrganisationUnit() );
         * programStageInstance.setExecutionDate( format.parseDate(
         * period.getStartDateString() ) );
         * 
         * programStageInstance.setDueDate( format.parseDate(
         * period.getStartDateString() ) );
         * 
