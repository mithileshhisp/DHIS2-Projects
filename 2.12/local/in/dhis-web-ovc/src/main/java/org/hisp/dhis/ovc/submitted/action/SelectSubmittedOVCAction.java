...
public class SelectSubmittedOVCAction implements Action
{
...
*/
        ...
        throws Exception
    {
        ...
        //PatientAttribute patientAttribute = patientAttributeService.getPatientAttribute( (int) ovcStatusonstant.getValue() );
        
        //System.out.println( "Size of Arrtibute Before Iterator -- " + patientAttributes.size() );
        // remove patient attribute name OVC Status like submitted,active inactive,reject exitpending
        ...
        //System.out.println( "Size of Arrtibute After Iterator -- " + patientAttributes.size() );
