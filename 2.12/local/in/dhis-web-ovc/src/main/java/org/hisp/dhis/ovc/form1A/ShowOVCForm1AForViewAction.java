 ...
 */
public class ShowOVCForm1AForViewAction     implements Action
{
    ...
    public String execute()
    {
        ...
        employeeListCHV = new ArrayList<Employee>( employeeService.getEmployeeByOrganisationUnitAndJobTitle( patient.getOrganisationUnit(), GetRegistrationFormAction.OVC_EMP_JOB_TITLE_CHV ) );
        ...
        Integer programStageInstanceId = ovcService.getProgramStageInstanceId( programInstanceId, programStage.getId(), period.getStartDateString() );
