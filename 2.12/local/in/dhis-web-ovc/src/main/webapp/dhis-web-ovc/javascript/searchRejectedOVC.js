...
//-----------------------------------------------------------------------------
//List && Search Rejected OVC
//-----------------------------------------------------------------------------

function listAllRejectedOVC()
{
	...
	contentDiv = 'listOVCRejectedDiv';
	
	jQuery('#listOVCRejectedDiv').load('getRejectedOVCList.action',{
		listAll:true
	},
	function(){
		
		showById('listOVCRejectedDiv');
...
function getDateField( container )
{
	...
	dateField += '<input type="text" id="searchText_' + container + '" name="searchText" style="width:160px;" onkeyup="searchRejectedOVCOnKeyUp( event );">';
	return dateField;
}
...
{
	$.ajax({
		url: 'getRejectedOVCList.action',
		type:"POST",
		data: params,
		success: function( html ){
				
				setInnerHTML( 'listOVCRejectedDiv', html );
				showById('listOVCRejectedDiv');
...
function searchRejectedOVCOnKeyUp( event )
{
...
function loadRejectedOVCList()
{
	hideById('updateOVCRegistrationFormInRejectionDiv');
