...
//-----------------------------------------------------------------------------
//List && Search ExitPending OVC
//-----------------------------------------------------------------------------

function listAllExitPendingOVC()
{
	...
	contentDiv = 'listOVCExitRequestedDiv';
	
	jQuery('#listOVCExitRequestedDiv').load('getExitPendingOVCList.action',{
		listAll:true
	},
	function(){
		
		showById('listOVCExitRequestedDiv');
...
function getDateField( container )
{
	...
	dateField += '<input type="text" id="searchText_' + container + '" name="searchText" style="width:160px;" onkeyup="searchExitPendingOVCOnKeyUp( event );">';
	return dateField;
}
...
{
	$.ajax({
		url: 'getExitPendingOVCList.action',
		type:"POST",
		data: params,
		success: function( html ){
				
				setInnerHTML( 'listOVCExitRequestedDiv', html );
				showById('listOVCExitRequestedDiv');
...
function searchExitPendingOVCOnKeyUp( event )
{
...
function loadExitPendingOVCList()
{
	hideById('updateOVCExitFormDiv');

	showById('searchDiv');
	
	listAllExitPendingOVC();
}
