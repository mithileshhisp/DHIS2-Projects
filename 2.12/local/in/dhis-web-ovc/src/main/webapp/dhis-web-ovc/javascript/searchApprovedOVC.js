...
// -----------------------------------------------------------------------------
// List && Search Approved OVC
// -----------------------------------------------------------------------------

function listAllApprovedOVC()
{
	...
	var selectOrgUnitInsideDashBoard = jQuery('#selectOrgUnitInsideDashBoard').val();
	
	jQuery('#loaderDiv').show();
	contentDiv = 'listOVCApprovedDiv';
	
	jQuery('#listOVCApprovedDiv').load('getApprovedOVCList.action',{
		listAll:true,
		selectOrgUnitInsideDashBoard:selectOrgUnitInsideDashBoard
	},
	function(){
		
		showById('listOVCApprovedDiv');
...
function getDateField( container )
{
	...
	dateField += '<input type="text" id="searchText_' + container + '" name="searchText" style="width:160px;" onkeyup="searchApprovedOVCOnKeyUp( event );">';
	return dateField;
}
...
{
	$.ajax({
		url: 'getApprovedOVCList.action',
		type:"POST",
		data: params,
		success: function( html ){
				
				setInnerHTML( 'listOVCApprovedDiv', html );
				showById('listOVCApprovedDiv');
...
function searchApprovedOVCOnKeyUp( event )
{
...
function loadApprovedOVCList()
{
	...
	hideById('ovcHouseHoldAssessmentFormDiv');
	
	hideById('OVCForm1ADataEntryFormDiv');
