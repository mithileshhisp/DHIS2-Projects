...
//-----------------------------------------------------------------------------
//List && Search Inactive OVC
//-----------------------------------------------------------------------------

function listAllInActiveOVC()
{
	...
	contentDiv = 'listOVCInActivedDiv';
	
	jQuery('#listOVCInActivedDiv').load('getInActiveOVCList.action',{
		listAll:true
	},
	function(){
		
		showById('listOVCInActivedDiv');
...
function getDateField( container )
{
	...
	dateField += '<input type="text" id="searchText_' + container + '" name="searchText" style="width:160px;" onkeyup="searchInActiveOVCOnKeyUp( event );">';
	return dateField;
}
...
{
	$.ajax({
		url: 'getInActiveOVCList.action',
		type:"POST",
		data: params,
		success: function( html ){
				
				setInnerHTML( 'listOVCInActivedDiv', html );
				showById('listOVCInActivedDiv');
...
function searchInActiveOVCOnKeyUp( event )
{
