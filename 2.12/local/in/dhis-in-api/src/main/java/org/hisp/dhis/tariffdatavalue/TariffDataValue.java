...
public class TariffDataValue implements Serializable
{
    ...
    */
    ...
    public TariffDataValue( OrganisationUnit organisationUnit, DataElement dataElement, DataSet dataSet, Date startDate, Date endDate, Double value, Date timestamp, String storedBy, String comment )
    {
        this.organisationUnit = organisationUnit;
        this.dataElement = dataElement;
        this.dataSet = dataSet;
