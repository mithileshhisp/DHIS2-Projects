...
trackerCapture.controller('WaterEstablishmentsSelectionController',
        function($rootScope,
                 $scope,
                 $modal,
                 $location,
            ...
            var waterEstablishmentsPrograms = [];
                ...
                if (angular.isObject($scope.selectedOrgUnit)) {
                    ...
                    ProgramFactory.getProgramsByOu($scope.selectedOrgUnit, $scope.selectedProgram).then(function(response){
                        ...
                        for(var i=0; i<response.programs.length; i++){
                            if(response.programs[i].id === $scope.waterEstablishmentsProgran ){
                                waterEstablishmentsPrograms.push(response.programs[i]);
                        ...
                        $scope.programs = waterEstablishmentsPrograms;
