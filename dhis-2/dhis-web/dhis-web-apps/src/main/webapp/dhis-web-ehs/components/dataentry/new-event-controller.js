...
trackerCapture.controller('EventCreationController',
    ...
    function prepareEvent(){
        ...
        OrganisationUnitService.getOrganisationUnitObject( tei.orgUnit ).then(function( organisationUnitObject ){
            //$scope.selectedCommunity = organisationUnitObjectObject;
            $scope.selectedOrgUnitForEvent = organisationUnitObject;

            dummyEvent = EventUtils.createDummyEvent(eventsByStage[stage.id], tei, program, stage, orgUnit, enrollment, $scope.selectedOrgUnitForEvent);
