...
function insertDataValues()
{
    ...
    $( '[name="entryfield"]' ).css( 'background-color', COLOR_WHITE ).css( 'border-color', COLOR_BORDER );
    $( '[name="entryselect"]' ).css( 'background-color', COLOR_WHITE ).css( 'border-color', COLOR_BORDER );
