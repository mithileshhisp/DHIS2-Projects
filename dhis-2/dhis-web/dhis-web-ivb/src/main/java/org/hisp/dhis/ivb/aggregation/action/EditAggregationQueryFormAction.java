...
public class EditAggregationQueryFormAction
    implements Action
{
    // -------------------------------------------------------------------------
    // Dependencies
    ...
    public String getAggregationCaseId()
    {
        return aggregationCaseId;
    }
        ...
        throws Exception
    {
        ...
        dataElement = caseAggregationCondition.getAggregationDataElement();
        
        operator = caseAggregationCondition.getOperator();
        ...
        if(caseAggregationConditions.size() > 0 && !operator.equalsIgnoreCase( Lookup.AGG_TYPE_BY_KEYFLAG_SCORE ))
        {
