    ...
    implements Action
{
        ...
        throws Exception
    {
        ...
        //System.out.println( " pbfQtyOrgUnits 1 -- " + pbfQtyOrgUnits.size() );
        pbfQtyOrgUnits.retainAll( selDataSet.getSources() );
        //System.out.println( " pbfQtyOrgUnits 2 -- " + pbfQtyOrgUnits.size() );
        ...
        //System.out.println( " pbfQtyOrgUnits 3 -- " + orgUnitIdsByComma );
        ...
        if ( tariff_authority != null )
        {
            ...
            //System.out.println( " tariff_setting_authority -- " + tariff_setting_authority );
        }
    ...
    public OrganisationUnit findParentOrgunitforTariff( OrganisationUnit organisationUnit, Integer tariffOULevel )
    {
        ...
        //System.out.println( " organisationUnitID -- " + organisationUnit.getId() );
        Integer ouLevel = organisationUnit.getHierarchyLevel();
        //System.out.println( " ouLevel -- " + ouLevel + " tariffOULevel -- " + tariffOULevel );
